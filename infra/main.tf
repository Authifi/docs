...
locals {
  ...
  # token it gets. Authifi's GitHub organization issues immutable subjects that
  # bind both owner and repository IDs:
  # `repo:<owner>@<owner-id>/<name>@<repo-id>:environment:<env>`.
